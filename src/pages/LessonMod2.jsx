            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 mb-6 border border-blue-100">
              <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center gap-2">
                ...
                <p className="mt-3 text-sm text-gray-600">
                  A short voiceover summarizing how Office of Chief Justice leverages digital tools to reach diverse audiences, 
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors cursor-pointer">
              <div className="flex items-center justify-center gap-3">
                ...
                <div className="text-left">
                  <p className="font-semibold text-gray-800">📎 Digital_Media_Overview_OCJ.pdf</p>
                  <p className="text-sm text-gray-600">A two-page reference guide summarizing digital channels, use cases, and Office of Chief Justice best practices.</p>
                </div>
              </div>
            </div>
          </div>
